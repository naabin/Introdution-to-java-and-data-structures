...
public class CollectGroupDemo {
	...
	public static void main(String[] args) {
		...
		Map<String, Long> map1 = Stream.of(names).map(String :: toUpperCase).collect(
		...
		IntStream.of(values).mapToObj(e -> e).collect(Collectors.groupingBy(e -> e, TreeMap :: new, Collectors.counting()))
		...
		MyStudent[] students = {
				...
				new MyStudent("Kim", "Johnson", "CA", 30, 78.1)
		};
		
		System.out.printf("%10s%10s\n", "Department", "Average");
		Stream.of(students).collect(
				Collectors.groupingBy(MyStudent :: getMajor, TreeMap :: new, Collectors.averagingDouble(MyStudent :: getScore)))
